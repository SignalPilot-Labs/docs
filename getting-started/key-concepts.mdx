...
<Card title="Learn More" icon="wrench" href="/guides/01-user-funnel-analysis">
  See real-world examples of SignalPilot in action
</Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Task Guides" icon="map" href="/guides/01-user-funnel-analysis">
